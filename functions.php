...
function aladvogados_files() {
  //wp_enqueue_script('google_fonts_preconnect_api', '//fonts.googleapis.com');
  //wp_enqueue_script('google_fonts_preconnect_static', '//fonts.gstatic.com');
  //wp_enqueue_script('google_fonts', '//fonts.googleapis.com/css2?family=Inter:wght@400;600;700&display=swap');
